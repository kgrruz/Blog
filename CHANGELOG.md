...
### Add filter to broken html post content.
...
### Move crud operations to admin content context.
...
### Remove function translation from notify text message to key langs.
...
### Change module version. (tag: v1.0.5)
