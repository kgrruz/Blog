...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Products.Developer.Delete');
$can_edit		= $this->auth->has_permission('Products.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/products/edit/' . $record->id_product, '<span class="icon-pencil"></span> ' .  $record->product_name); ?></td>
				<?php else : ?>
