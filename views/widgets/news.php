...
<?php foreach($posts as $post){ ?>
  <li class="list-group-item">
     <div class="media">
       <img class="mr-3" style="height:67px;width:100px" src="<?php echo base_url(); ?>uploads/blog/posts_preview/<?php echo ($img = $post->preview_image)?$img:'no_image.png'; ?>" alt="image_preview">
